import { ScrollView,StyleSheet, Text, SafeAreaView, Image, TouchableOpacity, View } from 'react-native';
    ...
    <View style={styles.cardContainer}>
      ...
      <View style={styles.cardContainer}>
        ...
        <View style={styles.card}>
          ...
          <TouchableOpacity style={styles.botondescargar} onPress={() => {navigation.navigate('');}}>             
              <Text style={styles.buttonTextDescargar}>DESCARGAR</Text>
              <Image style={styles.imagendescargar} source={require('../../../assets/icono_descarga.png')}/>
          </TouchableOpacity>
        </View>
